...
- Verified: Xcode build-for-testing passed with no warnings; 3/3 tests passed, including selecting Exact text and finding its scoring input; live rubric scoring returned 4/4; oversized judge input returned an actionable unscored error.
...
- Steering: expected or required text must be directly editable in the scoring section, not buried inside the case editor.
