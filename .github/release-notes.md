...
The app and disk image are Developer ID signed. The disk image is notarized by Apple and includes its notarization ticket. `SHA256SUMS.txt` contains the installer checksum.
